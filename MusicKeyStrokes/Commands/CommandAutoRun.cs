...
{
    class CommandAutoRun : Command
    {
        public override string Name => Keys.Z.ToString();

        public override string NameTelegram => "/autorun";

        public override string Description => "AutoRun in Game";

        public override string Execute(string payload)
        {
            Keyboard keyboard = new Keyboard();

            keyboard.Send(Keyboard.ScanCodeShort.SHIFT);
